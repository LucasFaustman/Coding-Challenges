...
function apple(x){
    //   first should convert x to a number, square it, then use a ternary
      
      return Number(x)**2 > 1000 ? "It's hotter than the sun!!" : "Help yourself to a honeycomb Yorkie for the glovebox."
    
    }
    
    // P: input will either be a positive intger or a string
    // R: return a string saying one thing if its hotter than 1000 p**2, and another string if lower
    // E: (4), 'Help yourself to a honeycomb Yorkie for the glovebox.'