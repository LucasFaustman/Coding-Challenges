...
function spoonerize(words) {
    //I can use template literate and slice
...
//P: will be a string with 2 words. always will contain only 2 words. will be upper or lowercase. might be numbers. unclear if symbols included
//Return the same string but with the first characters of each swapped
